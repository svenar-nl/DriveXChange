...
class ROBOT {
    public:
        ...
        void setup_pins_motor_left(PinName pwm1, PinName pwm2);
        void setup_pins_motor_right(PinName pwm1, PinName pwm2);
        ...
        void setup_pins_motor_forklift(PinName pwm1, PinName pwm2);
    ...
    private:
        ...
        HBridgeDCMotor motor_left;  // TODO C++ why u so bitch
        HBridgeDCMotor motor_right; // TODO C++ why u so bitch
};
